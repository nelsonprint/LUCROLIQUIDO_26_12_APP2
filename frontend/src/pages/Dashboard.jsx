              ...
              {monthsWithRevenue.length > 0 && (
                <Card className="glass border-white/10 border-l-4 border-l-purple-500" data-testid="monthly-score-card">
                  <CardHeader>
                    ...
                    <p className="text-xs text-gray-400 mt-1">Acompanhe a evolução da saúde financeira do seu negócio</p>
                  </CardHeader>
                  <CardContent>
                    <ResponsiveContainer width="100%" height={350}>
                      <LineChart data={monthsWithRevenue.map(item => ({
                        month: item.month,
                        score: item.lucro > 0 ? Math.min(100, (item.lucro / item.faturamento) * 100 * 1.5) : 0
                      }))}>
                        <defs>
                    ...
                    <div className="mt-6 grid grid-cols-4 gap-4">
                      <div className="text-center p-3 bg-red-500/20 rounded-lg border border-red-500/30">
                        ...
                        <p className="text-sm font-bold text-red-400">0-25</p>
                      </div>
                      <div className="text-center p-3 bg-yellow-500/20 rounded-lg border border-yellow-500/30">
                        ...
                        <p className="text-sm font-bold text-yellow-400">26-50</p>
                      </div>
                      <div className="text-center p-3 bg-blue-500/20 rounded-lg border border-blue-500/30">
                        <p className="text-xs text-gray-400">Bom</p>
                        <p className="text-sm font-bold text-blue-400">51-75</p>
                      </div>
                      <div className="text-center p-3 bg-green-500/20 rounded-lg border border-green-500/30">
                        <p className="text-xs text-gray-400">Excelente</p>
                        <p className="text-sm font-bold text-green-400">76-100</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
