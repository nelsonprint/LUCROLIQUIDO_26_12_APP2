...
const AdminPanel = ({ user, onLogout }) => {
  ...
  const fetchStats = async () => {
    try {
      const response = await axiosInstance.get(`/admin/stats?user_id=${(user?.id || user?.user_id)}`);
  ...
  const fetchUsers = async () => {
    try {
      const response = await axiosInstance.get(`/admin/users?user_id=${(user?.id || user?.user_id)}`);
  ...
  const fetchSubscriptions = async () => {
    try {
      ...
      const response = await axiosInstance.get(
        `/admin/subscriptions?user_id=${(user?.id || user?.user_id)}${status ? `&status=${status}` : ''}`
      );
  ...
  const fetchRevenueChart = async () => {
    try {
      const response = await axiosInstance.get(`/admin/revenue-chart?admin_user_id=${(user?.id || user?.user_id)}`);
  ...
  const toggleUserStatus = async (targetUserId) => {
    ...
    try {
      const response = await axiosInstance.post(
        `/admin/user/${targetUserId}/toggle-status?admin_user_id=${(user?.id || user?.user_id)}`
      );
