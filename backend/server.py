...
async def enviar_orcamento_whatsapp(orcamento_id: str):
    ...
    base_url = os.environ.get('BACKEND_URL', 'https://reportflow-21.preview.emergentagent.com')
...
async def gerar_link_supervisor(funcionario_id: str):
    ...
    if empresa and empresa.get("slug"):
        supervisor_url = f"{base_url}/api/app/{empresa['slug']}/supervisor"
    else:
    ...
    mensagem = f"""🏗️ *App do Supervisor - {empresa_nome}*
